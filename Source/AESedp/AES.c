	...
	const AESData *ExpandedKey, long Nr)
{
	...
	* (AESData *) Plaintext = State;
	...
	#define AESExpandKeyForEncryption _AESExpandKeyForEncryption
	#define AESExpandKeyForDecryption _AESExpandKeyForDecryption
	#define AESEncryptWithExpandedKey _AESEncryptWithExpandedKey
	#define AESDecryptWithExpandedKey _AESDecryptWithExpandedKey
	#define AESEncryptCBC		_AESEncryptCBC
	#define AESDecryptCBC		_AESDecryptCBC
